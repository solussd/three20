...
#import "TTTableCheckmarkItemCell.h"
...
@implementation TTTableCheckmarkItemCell
...
- (void)layoutSubviews {
    ...
    self.accessoryType = self->item.checked ? UITableViewCellAccessoryCheckmark : UITableViewCellAccessoryNone;
}
...
- (void)setObject:(id)object {
    if (self->item != object) {
        ...
        if ([object isKindOfClass:[TTTableCheckmarkItem class]]) {
            ...
            self.accessoryType = newItem.checked ? UITableViewCellAccessoryCheckmark : UITableViewCellAccessoryNone;
